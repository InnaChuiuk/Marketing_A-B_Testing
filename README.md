...
## Project Overview
Analysis of marketing campaign effectiveness using statistical methods in Python. Compare two user groups: the test group that saw the actual advertisement (ad) and the control group that saw a public service announcement (psa).
...
## Conclusions
* With a p-value of 0.039 (lower than the 0.05 threshold), the null hypothesis can be successfully rejected. The increase in conversion for the test group is statistically significant, confirming that the advertisement effectively drives user action.
